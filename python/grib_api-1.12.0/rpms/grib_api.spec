...
%define prefix /usr/local/grib_api_dir
%define _prefix /usr/local/grib_api_dir
%define _target_platform x86_64-apple-darwin13.1.0
...
%define configure_args  '--prefix=/usr/local/grib_api_dir' '--enable-python' 'CC=/usr/bin/clang' 'LDFLAGS=-L/usr/local/lib'

Name: %{pkgname}
Version: %{version}
Release: %{rel}
Distribution: darwin13.1.0 
