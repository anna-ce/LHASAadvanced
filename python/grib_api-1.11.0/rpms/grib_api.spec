...
%define prefix /Users/patrice/Development/landslide/python/grib_api_dir
%define _prefix /Users/patrice/Development/landslide/python/grib_api_dir
%define _target_platform x86_64-apple-darwin12.4.0
...
%define configure_args  '--with-jasper=/usr/local/lib' '--prefix=/Users/patrice/Development/landslide/python/grib_api_dir' 'CC=/usr/bin/clang'

Name: %{pkgname}
Version: %{version}
Release: %{rel}
Distribution: darwin12.4.0 
