...
function get_trmm_24_legend() {
	...
	html += "	<i style='border-bottom:solid; color: #FFFFFF'></i>&nbsp;&nbsp;1mm<br/>"
	html += "	<i style='border-bottom:solid; color: #E0F3DB'></i>&nbsp;&nbsp;2mm<br/>"
	html += "	<i style='border-bottom:solid; color: #CCEBC5'></i>&nbsp;&nbsp;3mm<br/>"
	html += "	<i style='border-bottom:solid; color: #A8DDB5'></i>&nbsp;&nbsp;5mm<br/>"
	html += "	<i style='border-bottom:solid; color: #7BCCC4'></i>&nbsp;&nbsp;8mm<br/>"
	html += "	<i style='border-bottom:solid; color: #4EB3D3'></i>&nbsp;13mm<br/>"
	html += "	<i style='border-bottom:solid; color: #2B8CBE'></i>&nbsp;21mm<br/>"
	html += "	<i style='border-bottom:solid; color: #0868AC'></i>&nbsp;34mm<br/>"
	html += "	<i style='border-bottom:solid; color: #084081'></i>&nbsp;55mm<br/>"
	html += "	<i style='border-bottom:solid; color: #810F7C'></i>&nbsp;89mm<br/>"
	html += "	<i style='border-bottom:solid; color: #4D004B'></i>144mm<br/>"
	html += "	<br/>"
