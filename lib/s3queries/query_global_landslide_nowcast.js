var util 		= require('util'),
	...
	var source_url 	= "http://ojo-bot.herokuapp.com"
	
	var options = {
		bucket: 		app.config.regions.Global.bucket,
		subfolder: 		'global_landslide_nowcast',
		browse_img: 	"_thn.jpg",
		geojson: 		undefined,
		topojson: 		".topojson",
		...
		product: 		'global_landslide_nowcast',
		tags: 			['global_landslide_nowcast','landslide','hazard', 'disaster'],
		bbox: 			bbox,											// lng,lat bottom left - top right
		target: 		[centerlon, centerlat],
		minzoom: 		4,
		attributes: [
			{
				"name": "global_landslide_nowcast",
	...
	options.tilejson = function(req) {
		...
		var host				= req.protocol + "://"+ req.get('Host') 
		var url1 				= host + "/products/global_landslide_nowcast/vt/Global/"+ year+"/" + doy+"/{z}/{x}/{y}/" + prefix+".mvt"
		
		var json = {
			"tilejson": 	"1.0.0",
			"name": 		"Global Landslide Forecast 1 Day",
			"description": 	"Global Landslide Forecast for next 24hours",
			"version": 		"1.0.0",
			...
			"dataset": [
				{
		            ...
		            "description": "This dataset provides a Global Landslide Nowcast",
		            "distribution": [
		                {
    ...
    query.source			= "global_landslide_model"
