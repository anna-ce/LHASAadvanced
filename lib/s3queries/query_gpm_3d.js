var util 		= require('util'),
	...
	var gpm_3d_levels		= [ 1,2,3,5,10,20,40,70,120,200,350,600 ]

	var gpm_3d_text 		= [	"legend.precipitation_gpm.legend.1",
	...
	build_json(json_3d,   gpm_3d_levels)
	...
	options.tilejson = function(req) {
		...
		var url1 				= host + "/products/gpm_3d/vt/Global/"+ year+"/" + doy+"/{z}/{x}/{y}/" + prefix+".mvt"
		
		var json = {
			"tilejson": 	"1.0.0",
			"name": 		"GPM/IMERG 1Day",
			"description": 	"GPM/IMERG accumulated precipitation for last 3 days",
			"version": 		"1.0.0",
