var util 		= require('util'),
	...
	var options = {
		...
		tags: 			['precip_3d', 'precipitation', 'rainfall'],
	...
	var gpm_3d_text 		= [	"legend.precipitation_gpm.legend.1p3",
								"legend.precipitation_gpm.legend.2p1",
								"legend.precipitation_gpm.legend.3p4",
								"legend.precipitation_gpm.legend.5p5",
								"legend.precipitation_gpm.legend.8p9",
								"legend.precipitation_gpm.legend.14p4",
								"legend.precipitation_gpm.legend.23p3",
								"legend.precipitation_gpm.legend.37p7",
								"legend.precipitation_gpm.legend.61p0",
								"legend.precipitation_gpm.legend.98p7",
								"legend.precipitation_gpm.legend.159p7",
								"legend.precipitation_gpm.legend.258p4"]
	...
	options.legend = function(req) {
		...
		html += "  <div class='legend-title'>"+ req.gettext("legend.precipitation_gpm.gpm_3d")+"</div>"
