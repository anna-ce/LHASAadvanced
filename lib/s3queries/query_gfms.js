...
var util 		= require('util'),
	...
	// Colorbrewer2 sequential six classes color blindsafe
	//var colors  	= [ "#a50f15",  "#de2d26", "#fb6a4a", 	"#fc9272", "#fcbba1", 	"#fee5d9"]
	...
	options.legend = function(req) {
		...
		html += "	   <li><span style='background: " + colors[0] + "'></span>&nbsp;"+ req.gettext("legend.flood_nowcast.legend.255mm") +"</li>"
		html += "	   <li><span style='background: " + colors[1] + "'></span>&nbsp;"+ req.gettext("legend.flood_nowcast.legend.200mm") +"</li>"
		html += "	   <li><span style='background: " + colors[2] + "'></span>&nbsp;"+ req.gettext("legend.flood_nowcast.legend.100mm") +"</li>"
		html += "	   <li><span style='background: " + colors[3] + "'></span>&nbsp;"+ req.gettext("legend.flood_nowcast.legend.50mm") +"</li>"
		html += "	   <li><span style='background: " + colors[4] + "'></span>&nbsp;"+ req.gettext("legend.flood_nowcast.legend.20mm") +"</li>"
		html += "	   <li><span style='background: " + colors[5] + "'></span>&nbsp;"+ req.gettext("legend.flood_nowcast.legend.10mm") +"</li>"
		html += "    </ul>"
		html += "  </div>"
		...
		//console.log("new legend title", req.gettext("legend.flood_nowcast.title"))
	...
	options.tilejson = function(req) {
		...
		var url1 				= host + "/products/gfms/vt/Global/"+ year+"/" + doy+"/{z}/{x}/{y}/" + prefix+".mvt"
		
		var json = {
			"tilejson": 	"1.0.0",
			"name": 		"GFMS Forecast",
			"description": 	"GFMS Flood Forecast for next 24hrs",
			"version": 		"1.0.0",
			"attribution": 	"UMD",
			"scheme": 		"xyz",
			"tiles": [
