var util 		= require('util'),
	...
	var options = {
		...
		tags: 			['precip_30mn_3hr', 'precipitation', 'rainfall'],
		minzoom: 		6,
		attributes: [
			{
				"name": "precip",
		...
		prefix_map: 	{
			'precip_30mn_3hr': 	'gpm_30mn_3hr'
		}
	}
	
	var hexColors     		= [ "#c0c0c0", "#018414","#018c4e","#02b331","#57d005","#b5e700","#f9f602","#fbc500","#FF9400","#FE0000","#C80000","#8F0000"]
	
	var gpm_levels			= [ 1,2,3,5,10,20,40,70,120,200,350,600 ]
	
	var gpm_text 			= [	"legend.precipitation_gpm.legend.1",
	...
	options.legend = function(req) {
		...
		html += "  <div class='legend-title'>"+ req.gettext("legend.precipitation_gpm.gpm_30mn_3hr")+"</div>"
	...
	options.tilejson = function(req) {
		...
		var url1 				= host + "/products/gpm_30mn_3hr/vt/Global/"+ year+"/" + doy+"/{z}/{x}/{y}/" + prefix+".mvt"
		
		var json = {
			"tilejson": 	"1.0.0",
			"name": 		"GPM/IMERG 30mn 3hrs",
			"description": 	"GPM/IMERG accumulated precipitation every 30mn for last 3 hours",
			"version": 		"1.0.0",
