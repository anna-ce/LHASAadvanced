var util 		= require('util'),
	...
	var options = {
		...
		subfolder: 		'global_landslide_nowcast_30mn',
		browse_img: 	"_thn.jpg",
		geojson: 		undefined,
		topojson: 		".topojson",
		...
		product: 		'global_landslide_nowcast_30mn',
		tags: 			['global_landslide_nowcast_30mn','landslide','hazard', 'disaster'],
		bbox: 			bbox,							// lng,lat bottom left - top right
		target: 		[centerlon, centerlat],
		minzoom: 		6,
		attributes: [
			{
				"name": "global_landslide_nowcast_30mn",
	...
	options.metadata = function(req) {
		...
		var accrualPeriodicity	= "R/P30MN";
			...
			"dataset": [
				{
		            ...
		            "title": 	"Landslide Nowcast Every 30mn",
