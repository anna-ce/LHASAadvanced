var util 		= require('util'),
	...
	var gpm_7d_levels		= [ 1,2,3,5,10,20,40,70,120,200,350,600 ]
	
	var gpm_7d_text 		= [	"legend.precipitation_gpm.legend.1",
	...
	options.tilejson = function(req) {
		...
		var url1 				= host + "/products/gpm_7d/vt/Global/"+ year+"/" + doy+"/{z}/{x}/{y}/" + prefix+".mvt"
		
		var json = {
			"tilejson": 	"1.0.0",
			"name": 		"GPM/IMERG 7-Day",
			"description": 	"GPM/IMERG accumulated precipitation for last 7 days",
			"version": 		"1.0.0",
