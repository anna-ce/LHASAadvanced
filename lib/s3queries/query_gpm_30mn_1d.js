var util 		= require('util'),
	...
	var options = {
		...
		tags: 			['precip_30mn_1d', 'precipitation', 'rainfall'],
		minzoom: 		6,
		attributes: [
			{
				"name": "precip",
	...
	options.legend = function(req) {
		...
		html += "  <div class='legend-title'>"+ req.gettext("legend.precipitation_gpm.gpm_30mn_1d")+"</div>"
	...
	options.tilejson = function(req) {
		...
		var url1 				= host + "/products/gpm_30mn_1d/vt/Global/"+ year+"/" + doy+"/{z}/{x}/{y}/" + prefix+".mvt"
		
		var json = {
			"tilejson": 	"1.0.0",
			"name": 		"GPM/IMERG 30mn 1Day",
			"description": 	"GPM/IMERG accumulated precipitation every 30mn for last 24hours",
			"version": 		"1.0.0",
