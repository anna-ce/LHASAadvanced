var util 		= require('util'),
	...
	var options = {
		...
		subfolder: 		'global_landslide_nowcast_3hr',
		browse_img: 	"_thn.jpg",
		geojson: 		undefined,
		topojson: 		".topojson",
		...
		product: 		'global_landslide_nowcast_3hr',
		tags: 			['global_landslide_nowcast_3hr','landslide','hazard', 'disaster'],
		bbox: 			bbox,							// lng,lat bottom left - top right
		target: 		[centerlon, centerlat],
		minzoom: 		6,
		attributes: [
			{
				"name": "global_landslide_nowcast_3hr",
