var util 		= require('util'),
	...
	options.legend = function(req) {
		...
		html += "  <div class='legend-title'>"+ req.gettext("legend.forecastio.title")+"</div>"
		html += "  <div class='legend-scale'>"
		html += "    <ul class='legend-labels'>"
		html += "	   <li><img src='"+iconUrl+"' width=32 />&nbsp;"+ req.gettext("legend.forecastio.legend") +"</li>"
		html += "    </ul>"
		html += "  </div>"
		html += "<div class='legend-source'>"+ req.gettext("legend.forecastio.source.label")+": <a href='" + source_url+"'>"+ req.gettext("legend.forecastio.source.source")+"</a>"
		html += "</div>&nbsp;&nbsp;"
