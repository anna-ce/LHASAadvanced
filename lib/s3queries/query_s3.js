		...
		if( this.bucketList[key] != undefined ) {				
			...
			function CheckIfProductExists(slf, key) {
				...
				var mapAction 		= as.action(req.gettext("actions.map"),"ojo:map")
										.addHttpGet("legend", 	req.gettext("mapinfo.legend"), 	host+"/mapinfo/"+slf.options.subfolder+"/legend", 	null, "text/html")
										.addHttpGet("style", 	req.gettext("mapinfo.style"), 	host+"/mapinfo/"+slf.options.subfolder+"/style", 	null, "application/json")
