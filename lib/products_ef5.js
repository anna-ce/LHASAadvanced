var util 			= require('util'),
	...
	module.exports = {
		...
		product: function(req,res) {
			...
			var ef5_data_dir 	= app.root+"/data/ef5/"
			var product			= ef5_data_dir+year+"/"+doy+"/"+id
		...
		browse: function(req,res) {
			...
			res.render("products/flood_forecast", {
				...
				description: 	req.gettext("legend.flood_forecast.title"),
				image: 			host+"/products/flood_forecast/"+year+"/"+doy+"/thn.jpg",
