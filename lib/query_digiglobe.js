...
// This requires a password from there: https://evwhs.digitalglobe.com
// Approved my NGA. I guess?
//
	...
	request({
			...
			if( !error && (response.statusCode == 200) ) {
			    ...
			    parser.parseString(body, function (err, result) {
					...
					var exceptionReport		= result['ows:ExceptionReport']
					if(exceptionReport) {
						exception = exceptionReport['ows:Exception'][0]
						exceptionText = exception['ows:ExceptionText']
						console.log("DigiGlobe Error", exceptionText)
						cb(-1, exceptionText)
						return
					}
