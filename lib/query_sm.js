var util 		= require('util'),
	...
	function QueryByID(req, user, year, doy, credentials, cb ) {
		...
		var key =  "sm" + "/" + date.year() + "/" + doy + "/" + "sm."+year+month+day+".120000.tif"
		...
		app.s3.headObject(params, function(err, data) {
			...
			var browse_img_url		= s3host+"sm."+year+month+day+".120000_thn.jpg"
			var topojson_url		= s3host+"sm."+year+month+day+".120000_levels.topojson"
			var topojson_file		= s3host+"sm."+year+month+day+".120000_levels.topojson.gz"
