...
var planetLabsDir	= tmpdir + "/planet-labs"
...
module.exports = {
	...
	map: function(req,res) {
		...
		if (query == 'rgb_composite') {
			thn			= host+"/products/planetlabs/"+ id + "/thn"
		} else {
			topojson	= host+"/products/planetlabs/"+ id + "/surface_water.topojson"			
		}
	...
	index: function(req, res) {
		...
		.end( function(response) {
			...
			var data_url;
			if( query == 'rgb_composite') {
				data_url = host+"/products/planetlabs/"+id+"/full"
			} else {
				data_url = host+"/products/planetlabs/"+id+"/surface_water.topojson.gz"
			}
			...
			res.render("products/planetlabs", {
				...
				data: 			data,
				data_url: 		data_url,
				image: 			host+"/products/planetlabs/"+id+"/thn",
